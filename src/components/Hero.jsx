      ...
      <div className="grid gap-12 md:gap-16 md:grid-cols-[auto_1fr] items-center w-full">
        ...
        >
          ...
          <p className="max-w-lg text-base leading-relaxed text-slate-400 mx-auto md:mx-0">
            B.Tech student in AI & Data Science building intelligent systems that go beyond generation — 
            from agentic desktop automation to NLP-powered academic platforms. 
            I focus on making AI actually execute: reliable, deterministic, and production-ready.
          </p>
