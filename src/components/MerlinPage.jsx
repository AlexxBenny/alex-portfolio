      ...
      >
        ...
        <main className="relative mx-auto flex max-w-5xl flex-col px-4 pb-24 pt-28 sm:px-6">
          ...
          <Section id="get-started">
            <SectionLabel number="06" text="Get Started" />
            <motion.div
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, amount: 0.3 }}
            ...
            >
              ...
              <p className="mt-3 mx-auto max-w-lg text-base text-slate-400">
                MERLIN is pip-installable and open source. Three commands to a
                working system.
              </p>
            </motion.div>
            ...
            >
              <div className="rounded-xl border border-accent/20 bg-accent/[0.03] overflow-hidden">
                <div className="flex items-center gap-2 px-4 py-2.5 border-b border-accent/10 bg-accent/[0.02]">
                ...
                <div className="p-5 font-mono text-sm space-y-1.5">
                  ...
                  <p>
                    <span className="text-slate-600">$</span>{" "}
                    <span className="text-emerald-400">{github.init}</span>
                  </p>
                  <p>
                    <span className="text-slate-600">$</span>{" "}
                    <span className="text-white">{github.run}</span>
                  </p>
                </div>
              </div>
            </motion.div>
